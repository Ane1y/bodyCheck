...
public class DetectRectangle {
    ...
    public DetectRectangle(File... names) throws IOException {
        nu.pattern.OpenCV.loadLocally();
        // System.load("C:/DIGITAL_HOME/ocr/opencv_java420.dll");
        Mat tempor = Imgcodecs.imread(Detector.mainFolder + "/imgs/iam22.jpg");
        ...
        Imgcodecs.imwrite(Detector.mainFolder + "/imgs/newImage.jpg", src);
